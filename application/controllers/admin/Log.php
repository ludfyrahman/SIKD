...
class Log extends CI_Controller {
    ...
    public function index(){
		...
		$data['log'] = $this->db->query("SELECT * FROM $this->low order by created_at desc LIMIT 10")->result_array();
        $data['day'] = $this->db->query("SELECT * FROM $this->low GROUP BY DAY(created_at) LIMIT 5")->result_array();
