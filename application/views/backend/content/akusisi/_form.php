          ...
          <form action="" method="post">
            <div class="row">
              ...
              <div class="form-group col-md-6" >
                  ...
                  <input type="text" id="datepicker" value='<?= Input_Helper::postOrOr('tanggal_serah_terima', $data['tanggal_serah_terima']) ?>' name="tanggal_serah_terima" class="form-control" placeholder="Masukkan Tanggal Serah Terima" required>
              </div>
